...
$stmt = $pdo->prepare("
    ...
    WHERE t.professor_id = ? AND t.is_active = 1
    ORDER BY
...
<div class="timetable-filters">
    ...
    <div style="
        ...
        align-items:center;
        gap:6px;">
        <i class="fa-solid fa-circle-info" style="color:var(--color-mint-dark);"></i>
        Total sessions this week:
        <strong style="color:var(--color-text-dark);"><?= count($allSessions) ?></strong>
    </div>
</div>
