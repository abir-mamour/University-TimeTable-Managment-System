...
function notifUrl(string $title): ?string {
    return match($title) {
        ...
        'Session Updated',
        'Session Removed',
        'New Timetable Published'  => '/TimeTable/pages/professor/schedule.php',

        'Request Accepted',
        'Request Rejected'         => '/TimeTable/pages/professor/requests.php',

        'Availability Updated',
        'Availability Cleared'     => '/TimeTable/pages/professor/availability.php',

        'Account Updated'          => '/TimeTable/pages/professor/profile.php',
