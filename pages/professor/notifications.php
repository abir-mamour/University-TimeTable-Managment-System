...
function filterNotifs(type) {
    ...
    const activeStyle   = 'var(--color-mint-dark)';
    const inactiveStyle = 'var(--color-white)';

    if (type === 'all') {
        btnAll.style.background    = activeStyle;
        btnAll.style.color         = 'white';
        btnUnread.style.background = inactiveStyle;
        btnUnread.style.color      = 'var(--color-text-mid)';
    } else {
        btnUnread.style.background = activeStyle;
        btnUnread.style.color      = 'white';
        btnAll.style.background    = inactiveStyle;
