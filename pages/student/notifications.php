...
function getNotifIcon($type) {
    return match($type) {
        'success' => ['fa-book-open',          'notif-icon-new'],
        'warning' => ['fa-building-columns',   'notif-icon-room'],
        'error'   => ['fa-clock-rotate-left',  'notif-icon-time'],
...
function notifUrl(string $title): ?string {
    return match($title) {
        ...
        'Group Changed',
        'Group Switched',
        'Group Switch Approved'    => '/TimeTable/pages/student/timetable.php',

        'Account Updated'          => '/TimeTable/pages/student/profile.php',
